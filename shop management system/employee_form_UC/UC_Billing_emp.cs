                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            SqlCommand cmd_orders_table = new SqlCommand("INSERT INTO orders VALUES(@order_no, @customer_cnic, @product_id, @product_price, @quantity)", con);
        ...
        private void confirm_bill_button_main_billing_employee_form_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    SqlCommand cmd_update_total_tb = new SqlCommand("INSERT INTO total_bill_tb VALUES(@customer_cnic, @order_no, @total_bill)", con);
